        ...
        <div class='container'>
            <center>
                ...
                <form >
                    <table width="100%">
                        <tr>
                            <td><a href='solicitarSeguro.jsp' class='button medium green'>Solicitar Seguro</a></td>
                            <td> </td>
                        </tr>
                        <tr><td><br></td><td></td></tr>
                        <tr>
                            <td><a href='consultarSeguro.jsp' class='button medium green'>Consultar Seguro</a></td>
                            <td></td>
                        </tr>
                        <tr><td><br></td><td></td></tr>
                        <tr>
