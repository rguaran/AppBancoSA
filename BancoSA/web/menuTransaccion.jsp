<%-- 
    Document   : menuTransaccion
    Created on : 25-Jun-2015, 12:05:07
    Author     : Rita
--%>
    ...
    <body>
        ...
        <section class='gray'>
            <div class='container'>
                ...
                <!--center>
                    <div>
                        <form action="PagarSeguroServlet" method="GET">
                            <input type="submit" value="Pagar Seguro" name="btnPagarSeguro">
                        </form>
                    </div>
                </center-->
                <center>
                    <div>
                        <form action="PagarPrestamoServlet" method="GET">
                            <input type="submit" value="Pagar Prestamo" name="btnPagarPrestamo">
                        </form>
                    </div>
                </center>
                <center>
