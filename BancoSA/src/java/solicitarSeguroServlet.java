 ...
 * @author Rita
 */
@WebServlet(urlPatterns = {"/solicitarSeguro"})
public class solicitarSeguroServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/solicitarSeguro.jsp").forward(request, response);
    }
